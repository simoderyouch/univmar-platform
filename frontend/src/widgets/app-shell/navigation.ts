import { Boxes, ClipboardList, FileText, FolderKanban, Grid3X3, Handshake, LayoutDashboard, Package, Paperclip, ReceiptText, ScrollText, Truck, Users, type LucideIcon } from "lucide-react";
