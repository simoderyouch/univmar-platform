import { Boxes, ClipboardList, FileText, FolderKanban, Handshake, LayoutDashboard, Package, ReceiptText, ScrollText, Truck, Users, type LucideIcon } from "lucide-react";
