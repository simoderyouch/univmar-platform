...
@Service public class AuditService {
    ...
    public void record(Long actorId, String action, String entityType, Long entityId, String detail) { events.save(new AuditEvent(actorId, action, entityType, entityId, detail)); }
}
