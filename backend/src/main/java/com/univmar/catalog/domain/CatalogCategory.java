...
public class CatalogCategory extends BaseEntity {
    ...
    public CatalogCategory(String slug, String name, int displayOrder, boolean localMaterial) {
        this.slug = slug;
        this.name = name;
    ...
    public void update(String slug, String name, int displayOrder, boolean localMaterial, boolean active) {
        this.slug = slug;
        this.name = name;
        this.displayOrder = displayOrder;
        this.localMaterial = localMaterial;
