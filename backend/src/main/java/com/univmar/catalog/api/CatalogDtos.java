...
public final class CatalogDtos {
 ...
 public record MaterialResponse(Long id, Long sourceProductId, String name, String slug, String category, String originCountry, String primaryColor, String description, String applications, boolean active, List<ImageResponse> images, List<VariantResponse> variants) { }
}
