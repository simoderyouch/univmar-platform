...
public class CatalogController {
 ...
 @GetMapping("/admin/categories") @PreAuthorize("hasRole('ADMIN')") public java.util.List<CatalogDtos.AdminCategoryResponse> adminCategories() { return service.adminCategories(); }
 @PostMapping("/admin/categories") @ResponseStatus(HttpStatus.CREATED) @PreAuthorize("hasRole('ADMIN')") public CatalogDtos.AdminCategoryResponse createCategory(@Valid @RequestBody CatalogDtos.CategoryRequest request) { return service.createCategory(request); }
 @PutMapping("/admin/categories/{id}") @PreAuthorize("hasRole('ADMIN')") public CatalogDtos.AdminCategoryResponse updateCategory(@PathVariable Long id, @Valid @RequestBody CatalogDtos.CategoryRequest request) { return service.updateCategory(id, request); }
 ...
 @PutMapping("/admin/materials/{materialId}/variants/{variantId}") @PreAuthorize("hasRole('ADMIN')") public CatalogDtos.VariantResponse updateVariant(@PathVariable Long materialId, @PathVariable Long variantId, @Valid @RequestBody CatalogDtos.VariantRequest request) { return service.updateVariant(materialId, variantId, request); }
 @DeleteMapping("/admin/materials/{materialId}/variants/{variantId}") @ResponseStatus(HttpStatus.NO_CONTENT) @PreAuthorize("hasRole('ADMIN')") public void deactivateVariant(@PathVariable Long materialId, @PathVariable Long variantId) { service.deactivateVariant(materialId, variantId); }
}
