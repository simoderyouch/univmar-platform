...
public final class InventoryDtos {
    ...
    public record MovementRequest(@NotNull @DecimalMin(value = "0.01", inclusive = false) BigDecimal quantityM2,
                                  @NotBlank String reason) {
    }

    public record AdjustmentRequest(@NotNull @DecimalMin("-9999999.99") BigDecimal quantityM2,
                                    @NotBlank String reason) {
    }

    public record ItemResponse(Long id, Long variantId, BigDecimal onHandM2, BigDecimal reservedM2,
                               BigDecimal availableM2, BigDecimal minStockM2, boolean active) {
    }
